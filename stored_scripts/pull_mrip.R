...
library("mriptacklebox",lib.loc = tacklebox_main_lib) ##think before you changed to library("mriptacklebox")
library("conflicted")
conflicts_prefer(dplyr::filter)  ##had to add because stats has a filter too

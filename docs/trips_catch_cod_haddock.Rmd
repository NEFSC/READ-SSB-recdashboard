...
[Data processing code](https://github.com/NEFSC/READ-SSB-recdashboard/blob/main/stored_scripts/groundfish_trips_catch.R) can be seen in the READ-SSB-recdashboard repository. 
...
For catch, we provide harvest (landed + unobserved), discards, and catch (harvest + discards) in numbers of fish for both species.
